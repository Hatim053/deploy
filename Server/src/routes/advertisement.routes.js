...
import { handleCreateAdvertisement, handleFetchLiveAds, handleDeleteAdvertisement, handleSearchedAdvertisements , handleFetchMyAdvertisements , handleSearchSuggestions , handleFeedAdvertisements } from '../controllers/advertisement.controller.js'
...
advertisementRoutes.get('/query/:searchedQuery/:location' , handleSearchSuggestions)
advertisementRoutes.get('/:serviceType/:location/:skip/:limit' , handleSearchedAdvertisements)
advertisementRoutes.get('/recentAds/:skip/:limit' , handleFeedAdvertisements)
